...
DEFAULT_SKIN = SystemInfo["HasFullHDSkinSupport"] and "cobraliberosat.pli/skin.xml" or "PLi-HD/skin.xml"  # SD hardware is no longer supported by the default skin.
